...
const MessageAd = () => {
  return (
    <div className='mt-10 bg-orange-100 py-5'>
      <div className='flex flex-col sm:flex-row w-[92%] sm:w-[70%] m-auto'>
        <div className='sm:basis-1/2 flex justify-center pl-4 sm:pl-20 pt-4 sm:pt-6'>
            <img src={Macbook} alt="macbookm4" className='w-full max-w-xs sm:max-w-none h-48 sm:h-64 object-contain' />
        </div>
        <div className='text-left p-5 sm:p-10 text-green-900 sm:basis-1/2'>
            <h1 className='text-2xl sm:text-3xl pb-2 font-bold'>Oloja's Week</h1>
            <div className='pb-3'>
